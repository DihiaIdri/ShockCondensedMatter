...
def main():
    metal_data = pa.read_excel('/Users/dihiaidrici/Desktop/SecondPaper/ShockInMetalProperties.xlsx', sheet_name='MetalData', header=1, index_col=0)
    position_initial = pa.read_excel('/Users/dihiaidrici/Desktop/SecondPaper/ShockInMetalProperties.xlsx', sheet_name='Position')
    ...
    # Al_Al2O3 = ShockCMatter(Al, SS, SS, Vip, ViT, xProj, xTar, xTarb, xSteel)
    # Al_state1 = Al_Al2O3.shock_interactions()
    # Zr_Al2O3 = ShockCMatter(Zr, SS, SS, Vip, ViT, xProj, xTar, xTarb, xSteel)
    # Zr_Al2O3.shock_interactions()
